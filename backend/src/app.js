...
const tenderDealershipAuthRoutes = require("./routes/tenderDealershipAuth.routes");
const tenderDealershipRoutes = require("./routes/tenderDealership.routes");
const tenderDealershipUserRoutes = require("./routes/tenderDealershipUser.routes");
...
app.use("/api/tender-dealership-auth", tenderDealershipAuthRoutes);
app.use("/api/tender-dealership", tenderDealershipRoutes);
app.use("/api/tender-dealership-user", tenderDealershipUserRoutes);
