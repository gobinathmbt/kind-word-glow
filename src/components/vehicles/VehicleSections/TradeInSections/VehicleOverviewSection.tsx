...
const VehicleOverviewSection: React.FC<VehicleOverviewSectionProps> = ({
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      await vehicleServices.updateVehicleOverview(vehicle._id, vehicle.vehicle_type, {
        ...cleanedData,
        module_section: "Vehicle Overview",
      });

      toast.success("Vehicle overview updated successfully");

      // Update heroImagePreview to reflect the new image immediately
      if (hasImageChanged) {
